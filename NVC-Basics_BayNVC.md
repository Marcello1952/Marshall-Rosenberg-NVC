...
| **AFFECTIONATE** compassionate friendlyloving
 openhearted sympathetic
 tenderwarm | **EXCITED** amazed
 animated
 ardent
 aroused
 dazzled
 ...
 invigorated
 lively
 passionate surprised
 vibrant | **HOPEFUL** expectant encouraged optimistic | **PEACEFUL** calm
 clearheaded comfortable centered
 content
 equanimity
 fulfilled
 mellow
...
| --- | --- | --- | --- |
| **CONFIDENT** empowered
 openproudsafesecure | **EXHILARATED**
blissful
 ecstatic
 elated
 ...
 revived
 |
| **ENGAGED** absorbed alert curious engrossedenchanted entranced fascinated interested intrigued involved spellbound stimulated
...
| **ANGRY** angry
 ...
 livid
 outraged
 resentful | **DISQUIET** agitatedalarmed
 discombobulated
 disconcerted disturbed
 perturbed rattledrestlessshocked
 startled
 surprised
 troubled
 turbulentturmoil
...
| **Subsistence and Security** | **Freedom** | **Meaning**
 |
| --- | --- | --- |
| _ **Physical Sustenance** _AirFoodHealth
 Movement
 Physical
 Safety
 Rest / sleep
 ShelterTouchWater | _ **Autonomy** _ChoiceEase IndependencePower Self-responsibility Space Spontaneity | **Sense of Self** Authenticity
 Competence
 CreativityDignityGrowthHealingHonestyIntegrity
 Self-acceptance
 Self-care
 Self-connection
 Self-knowledge
 ...
 Mattering to myself
 |
| _ **Security** _Consistency
 Order/Structure
 Peace (external)
 Peace of mind
 ProtectionSafety (emotional)
 StabilityTrusting | **To Matter** AcceptanceCareCompassion
 Consideration
 EmpathyKindnessMutual Recognition
 RespectTo be heard, seenTo be known, understood
 To be trusted
 Understanding others
 | **Understanding** AwarenessClarityDiscoveryLearningMaking sense of lifeStimulation
 |
|
 | **Community** Belonging
 Communication
...
| _This list builds on Marshall Rosenberg's original needs list with categories adapted from Manfred Max-Neef. Neither exhaustive nor definitive, it can be used for study and for discovery about each person's authentic experience._ |
 ...
 Celebration of life
 CommunionFaithFlowHopeInspiration
 MourningPeace (internal)
 Presence
 |
